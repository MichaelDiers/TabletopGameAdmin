namespace Md.Tga.SaveGameStatusSubscriber
{
    ...
    public class Function : PubSubFunction<SaveGameStatusMessage, ISaveGameStatusMessage, Function>
    {
        /// <summary>
        ...
        public Function(ILogger<Function> logger, IPubSubProvider<ISaveGameStatusMessage> provider)
