namespace Md.Tga.StartGameSeriesSubscriber
{
    ...
    public class Function : PubSubFunction<StartGameSeriesMessage, IStartGameSeriesMessage, Function>
    {
        /// <summary>
        ...
        public Function(ILogger<Function> logger, IPubSubProvider<IStartGameSeriesMessage> provider)
