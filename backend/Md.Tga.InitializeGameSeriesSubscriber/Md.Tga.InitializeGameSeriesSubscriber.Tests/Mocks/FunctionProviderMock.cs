namespace Md.Tga.InitializeGameSeriesSubscriber.Tests.Mocks
{
    ...
    internal class FunctionProviderMock : IPubSubProvider<IInitializeGameSeriesMessage>
    {
        private readonly IInitializeGameSeriesMessage expectedMessage;

        public FunctionProviderMock(IInitializeGameSeriesMessage expectedMessage)
        {
            this.expectedMessage = expectedMessage;
        }

        public Task HandleAsync(IInitializeGameSeriesMessage message)
        {
