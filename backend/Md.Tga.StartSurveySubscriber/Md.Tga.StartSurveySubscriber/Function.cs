namespace Md.Tga.StartSurveySubscriber
{
    ...
    public class Function : PubSubFunction<StartSurveyMessage, IStartSurveyMessage, Function>
    {
        /// <summary>
        ...
        public Function(ILogger<Function> logger, IPubSubProvider<IStartSurveyMessage> provider)
