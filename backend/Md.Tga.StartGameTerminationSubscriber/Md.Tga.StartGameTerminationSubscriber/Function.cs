namespace Md.Tga.StartGameTerminationSubscriber
{
    ...
    public class Function : PubSubFunction<StartGameTerminationMessage, IStartGameTerminationMessage, Function>
    {
        /// <summary>
        ...
        public Function(ILogger<Function> logger, IPubSubProvider<IStartGameTerminationMessage> provider)
