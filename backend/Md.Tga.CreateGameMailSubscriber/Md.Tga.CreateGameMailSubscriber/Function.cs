namespace Md.Tga.CreateGameMailSubscriber
{
    ...
    public class Function : PubSubFunction<CreateGameMailMessage, ICreateGameMailMessage, Function>
    {
        /// <summary>
        ...
        public Function(ILogger<Function> logger, IPubSubProvider<ICreateGameMailMessage> provider)
